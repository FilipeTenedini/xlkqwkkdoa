...
const Testimonials: React.FC = () => {
  return (
    <div className="w-full bg-primary-t-1 mb-4 flex flex-col items-center justify-center text-primary py-4 px-4 text-center">
      ...
      <div className="mb-2">
        Depois de ministrar <span className="text-yellow-950">15 edições</span> do curso presencialmente, resolvemos
