...
const results: {
...
}[] = [
  {
    ...
    icon: <CiStopwatch className="text-primary text-xl mr-2" />
  },
  {
    text: "Os materiais e técnicas mais modernos no mercado odontológico",
    icon: <AiOutlineProfile className="text-primary text-xl mr-2" />
  },
  {
    text: "Como evitar erros comuns e garantir resultados de alta qualidade",
    icon: <HiOutlineHandThumbDown className="text-primary text-xl mr-2" />
  },
  {
    text: "Como essa técnica TRANSFORMOU a minha carreira e pode transformar a sua também!",
    icon: <FaSortAmountUp className="text-primary text-xl mr-2" />,
  }
]
