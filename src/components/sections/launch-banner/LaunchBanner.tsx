    ...
    <div className="relative w-full flex py-4 text-black">
      <div className="w-full flex flex-col items-center justify-center">
        ...
        <div className="px-4 w-full flex justify-center mt-4 z-20">
          <Button className="w-full mb-6 max-w-[550px] font-bold text-xs md:text-md md:text-lg md:mb-2 shadow-sm shadow-primary-t-8 md:h-11 bg-gray-600" variant={"inverted"}>
